...
CustomDialog.show = function(title, message, options) {
  ...
  dialogDiv.innerHTML =
      ...
      '<div class="customDialogRadio"> '+
      (options.showRadio ?'<input type="radio" name="data_type" id="Integer_rad" value="Integer" checked > Integer<br>  '+
      '<input type="radio" id="Real_rad" name="data_type" value="Real" >Real <br>':'')+
      '</div>'+
